...
rows = [
    ...
    ("saldo_prom_tot_pasivo_max_u6m", "Saldo promedio pasivo - maximo U6M", "decimal", "t_360_cliente", "e_perm_aws",
     "doc", "cod_mes 202604-202511", "U6M (max)", "-2 a -7 meses"),
]
...
data2 = [
    ...
    ("t360 (NUEVO)", "t_360_cliente", "e_perm_aws", "saldos txs/planilla/tc/pasivo + flags + ratios",
     "frecuencia=1; cod_mes 202604-202511", "-2 a -7", "@U6M"),
    ("principalidad (NUEVO)", "t_nds_principalidad", "e_perm_aws", "motivo_principalidad",
     "fch_periodo=2026-04-30", "-2", "@FCH_PRINCIPALIDAD"),
...
notas = [
    ...
    ["Ventana UM", "ultimo mes = 202604"],
    ["Ventana U3M", "202604, 202603, 202602 (promedio)"],
    ["Ventana U6M", "202604, 202603, 202602, 202601, 202512, 202511"],
