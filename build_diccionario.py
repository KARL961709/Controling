...
rows += [
    ...
    ("tipo_entidad_castigo_vida", "BIG FOUR / OTROS / SIN CASTIGO", "varchar", "t_fact_report_rcc_rsk", "e_perm_aws",
     "tip_doc + key_value", "corte codmes<=202603; ventana>=202403", "U24M", "corte -3 / ventana 24M"),
    # ---- base_pea (PEA) ----
    ("edad_num", "Edad del cliente (valor numerico)", "int", "ds_rtd_rskvol_indicadores_pea", "e_perm_aws",
     "p_fecinformacion (poblacion PEA)", "p_fecinformacion=20260616", "Foto", "0"),
    ("rk_ing_num", "Renta / ingreso (valor numerico)", "decimal", "ds_rtd_rskvol_indicadores_pea", "e_perm_aws",
     "p_fecinformacion (poblacion PEA)", "p_fecinformacion=20260616", "Foto", "0"),
    # ---- rcc_castigo_num (montos/antiguedad castigo) ----
    ("monto_castigado_total", "Saldo castigado total (cuentas 8113/8123/8133)", "decimal", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "codmes=202604 (ventana 24m)", "Actual", "-2 meses"),
    ("monto_castigado_ibk", "Saldo castigado IBK (00002)", "decimal", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "codmes=202604", "Actual", "-2 meses"),
    ("monto_castigado_otros", "Saldo castigado otras entidades (<>00002)", "decimal", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "codmes=202604", "Actual", "-2 meses"),
    ("nro_entidades_castigo", "Nro entidades distintas con castigo (actual)", "bigint", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "codmes=202604", "Actual", "-2 meses"),
    ("max_dias_mora_castigo", "Maximo dias de mora del castigo", "int", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "codmes=202604", "Actual", "-2 meses"),
    ("meses_desde_ultimo_castigo", "Meses desde el ultimo reporte de castigo", "int", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "ventana 24m vs 202604", "U24M", "-2 meses (ref)"),
    ("meses_desde_primer_castigo", "Meses desde el primer reporte de castigo", "int", "t_fact_report_rcc_rsk", "e_perm_aws",
     "key_value + tip_doc", "ventana 24m vs 202604", "U24M", "-2 meses (ref)"),
